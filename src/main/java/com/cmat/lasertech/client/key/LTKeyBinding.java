...
public class LTKeyBinding extends KeyMapping {
    ...
    LTKeyBinding(String description, IKeyConflictContext keyConflictContext, KeyModifier keyModifier, InputConstants.Key key, String category,
